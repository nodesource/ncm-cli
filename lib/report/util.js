...
function moduleList (report, dividers) {
  ...
  report.forEach((pkg, ind) => {
    ...
    L(
      ...
      severityMeter(SEVERITY_RMAP[pkg.maxSeverity].toUpperCase())[0] + severityMeter(SEVERITY_RMAP[pkg.maxSeverity].toUpperCase())[1] + severityTextLabel(SEVERITY_RMAP[pkg.maxSeverity].toUpperCase()) +
